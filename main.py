...
Монштад, Ли Юэ, Инадзума, Сумеру, Фонтейн, Натлан, Снежная(пока не добавлена в игре) и соответственно им стихии: Анемо, Гео, Электро, Дендро, Гидро, Пиро и Крио.
...
В игре имеется свой огромный лор и каждый персонаж имеет свою уникальную историю, сюжет игры будет выходить еще на протяжении минимум 5 лет, появиться все больше друзей, а также врагов. 
Основной сюжет заключается в том что мы ищем своего родственника, по всему Тейвату.(Ищем брата или сестру зависит от того главного героя, которого вы выбрали в начале игры)
...
Кнопка Akasha поможет ознакомиться с рейтингом вашего персонажа, вы сможете сравнить своего персонажа с персонажем другого игрока, сайт также поможет рассчитать максимально выдаваемый урон за один раз ''',
        ...
        bot.send_media_group(call.message.chat.id, media)
        bot.send_message(call.message.chat.id, '''
Ци-ци немного отличается от остальных играбельных персонажей Геншин Импакт. 
...
Однако, за счет механики своей ульты и встроенного в пассивные способности баффа,  героиня способна занять позицию саб-дд, особенно при игре с Крио союзниками.
...
В свободное время она играет со своими друзьями и куклой Додоко, которую ей подарила мать. Рыцарь-искорка легко управляется с Пиро бомбами, нанося огромный урон.
        ...
        bot.send_media_group(call.message.chat.id, media)
        bot.send_message(call.message.chat.id, '''
Пиро копейщица, играющая от Долга жизни. 
