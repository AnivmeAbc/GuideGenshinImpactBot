...
# Установка бота
<ul>
<li>1. Склонируйте репозиторий:</li>
         ```bash
         git clone <URL_ВАШЕГО_РЕПОЗИТОРИЯ>
         cd <НАЗВАНИЕ_РЕПОЗИТОРИЯ>
         ```
<li>2. Установите библиотеку: Для установки используйте команду:</li> 
         ```bash
         pip install pyTelegramBotAPI
         ```
<li>3. Настройка токена бота: Добавьте токен вашего Telegram-бота:</li>
         ```bash
         BOT_API = 'API_KEY'
         ```
<li>4. Запуск бота: Для запуска бота используйте команду:</li>
         ```bash
         python main.py
         ```
